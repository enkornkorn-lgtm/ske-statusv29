...
const CACHE_NAME = CACHE_PREFIX + 'v8-3-restored-exact-20260725';
const STATIC_ASSETS = ['./manifest.json?v=8.3-restored-exact', './icon-192.png', './icon-512.png', './ske-logo.png'];
